...
baseline = (-0.800, -0.500)
    ...
    ga_incongruent_incorrect_neu = grand_average(list(incongruent_incorrect_erps_neu.values()))
    ga_incongruent_correct_neu = grand_average(list(incongruent_correct_erps_neu.values()))
    ga_incongruent_incorrect_pos = grand_average(list(incongruent_incorrect_erps_pos.values()))
    ga_incongruent_correct_pos = grand_average(list(incongruent_correct_erps_pos.values()))
    ga_incongruent_incorrect_neg = grand_average(list(incongruent_incorrect_erps_neg.values()))
    ga_incongruent_correct_neg = grand_average(list(incongruent_correct_erps_neg.values()))
    # log progress
...
ga_incongruent_incorrect_neu.plot_topomap(times=[0., 0.1, 0.2, 0.3, 0.4], ch_type='eeg', title='neutral')

ga_incongruent_incorrect_pos.plot_joint(picks='eeg', title='Positiv')
ga_incongruent_incorrect_pos.plot_topomap(times=[0., 0.1, 0.2, 0.3, 0.4], ch_type='eeg', title='Positiv')

ga_incongruent_incorrect_neg.plot_joint(picks='eeg', title='Positiv')
ga_incongruent_incorrect_neg.plot_topomap(times=[0., 0.1, 0.2, 0.3, 0.4], ch_type='eeg', title='Positiv')
